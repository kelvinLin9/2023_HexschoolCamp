<template>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0 Noto-Sans-TC-400 fs-16">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">首頁</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="#">定價</a>
            </li>
          </ul>
        </div>
      </div>
  ...
  <section class="serve container my-5">
    <div class="row my-5">
        ...
        <div class="col-12 col-sm-8 Noto-Sans-TC-900 text-white fs-48">
          我們相信透過 AI 技術，<br>
